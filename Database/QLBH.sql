USE [master]
GO
/****** Object:  Database [QLBH]    Script Date: 5/12/2022 3:01:05 PM ******/
CREATE DATABASE [QLBH]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'QLBH', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.NTT\MSSQL\DATA\QLBH.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'QLBH_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.NTT\MSSQL\DATA\QLBH_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
USE [QLBH]
GO
/****** Object:  Table [dbo].[CTHD]    Script Date: 5/12/2022 3:01:06 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[HOADON]    Script Date: 5/12/2022 3:01:06 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[KHACHHANG]    Script Date: 5/12/2022 3:01:06 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NHANVIEN]    Script Date: 5/12/2022 3:01:06 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SANPHAM]    Script Date: 5/12/2022 3:01:06 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[CTHD] ([SOHD], [MASP], [SL]) VALUES (1004, N'TV02', 10)
GO
INSERT [dbo].[CTHD] ([SOHD], [MASP], [SL]) VALUES (1004, N'TV03', 10)
GO
INSERT [dbo].[CTHD] ([SOHD], [MASP], [SL]) VALUES (1004, N'TV04', 10)
GO
...
GO
INSERT [dbo].[KHACHHANG] ([MAKH], [HOTEN], [DCHI], [SODT], [NGSINH], [NGDK], [DOANHSO]) VALUES (N'KH01', N'Nguyen Van A', N'731 Tran Hung Dao, Q5, TpHCM', N'8823451', CAST(N'1960-10-22T00:00:00' AS SmallDateTime), CAST(N'2006-07-22T00:00:00' AS SmallDateTime), 13060000.0000)
GO
INSERT [dbo].[KHACHHANG] ([MAKH], [HOTEN], [DCHI], [SODT], [NGSINH], [NGDK], [DOANHSO]) VALUES (N'KH02', N'Tran Ngoc Han', N'23/5 Nguyen Trai, Q5, TpHCM', N'908256478', CAST(N'1974-04-03T00:00:00' AS SmallDateTime), CAST(N'2006-07-30T00:00:00' AS SmallDateTime), 280000.0000)
GO
INSERT [dbo].[KHACHHANG] ([MAKH], [HOTEN], [DCHI], [SODT], [NGSINH], [NGDK], [DOANHSO]) VALUES (N'KH03', N'Tran Ngoc Linh', N'45 Nguyen Canh Chan, Q1, TpHCM', N'938776266', CAST(N'1980-06-12T00:00:00' AS SmallDateTime), CAST(N'2006-05-08T00:00:00' AS SmallDateTime), 3860000.0000)
GO
INSERT [dbo].[KHACHHANG] ([MAKH], [HOTEN], [DCHI], [SODT], [NGSINH], [NGDK], [DOANHSO]) VALUES (N'KH04', N'Tran Minh Long', N'50/34 Le Dai Hanh, Q10, TpHCM', N'917325476', CAST(N'1965-03-09T00:00:00' AS SmallDateTime), CAST(N'2006-02-10T00:00:00' AS SmallDateTime), 250000.0000)
GO
INSERT [dbo].[KHACHHANG] ([MAKH], [HOTEN], [DCHI], [SODT], [NGSINH], [NGDK], [DOANHSO]) VALUES (N'KH05', N'Le Nhat Minh', N'34 Truong Dinh, Q3, TpHCM', N'8246108', CAST(N'1950-03-10T00:00:00' AS SmallDateTime), CAST(N'2006-10-28T00:00:00' AS SmallDateTime), 21000.0000)
GO
INSERT [dbo].[KHACHHANG] ([MAKH], [HOTEN], [DCHI], [SODT], [NGSINH], [NGDK], [DOANHSO]) VALUES (N'KH06', N'Le Hoai Thuong', N'227 Nguyen Van Cu, Q5, TpHCM', N'8631738', CAST(N'1981-12-31T00:00:00' AS SmallDateTime), CAST(N'2006-11-24T00:00:00' AS SmallDateTime), 915000.0000)
GO
INSERT [dbo].[KHACHHANG] ([MAKH], [HOTEN], [DCHI], [SODT], [NGSINH], [NGDK], [DOANHSO]) VALUES (N'KH07', N'Nguyen Van Tam', N'32/3 Tran Binh Trong, Q5, TpHCM', N'916783565', CAST(N'1971-04-06T00:00:00' AS SmallDateTime), CAST(N'2006-01-12T00:00:00' AS SmallDateTime), 12500.0000)
GO
INSERT [dbo].[KHACHHANG] ([MAKH], [HOTEN], [DCHI], [SODT], [NGSINH], [NGDK], [DOANHSO]) VALUES (N'KH08', N'Phan Thi Thanh', N'45/2 An Duong Vuong, Q5, TpHCM', N'938435756', CAST(N'1971-01-10T00:00:00' AS SmallDateTime), CAST(N'2006-12-13T00:00:00' AS SmallDateTime), 365000.0000)
GO
INSERT [dbo].[KHACHHANG] ([MAKH], [HOTEN], [DCHI], [SODT], [NGSINH], [NGDK], [DOANHSO]) VALUES (N'KH09', N'Le Ha Vinh', N'873 Le Hong Phong, Q5, TpHCM', N'8654763', CAST(N'1979-09-03T00:00:00' AS SmallDateTime), CAST(N'2007-01-14T00:00:00' AS SmallDateTime), 70000.0000)
GO
INSERT [dbo].[KHACHHANG] ([MAKH], [HOTEN], [DCHI], [SODT], [NGSINH], [NGDK], [DOANHSO]) VALUES (N'KH10', N'Ha Duy Lap', N'34/34B Nguyen Trai, Q1, TpHCM', N'8768904', CAST(N'1983-05-02T00:00:00' AS SmallDateTime), CAST(N'2007-01-16T00:00:00' AS SmallDateTime), 67500.0000)
GO
INSERT [dbo].[NHANVIEN] ([MANV], [HOTEN], [SODT], [NGVL]) VALUES (N'NV01', N'Nguyen Nhu Nhut', N'927345678', CAST(N'2006-04-13T00:00:00' AS SmallDateTime))
GO
INSERT [dbo].[NHANVIEN] ([MANV], [HOTEN], [SODT], [NGVL]) VALUES (N'NV02', N'Le Thi Phi Yen', N'987567390', CAST(N'2006-04-21T00:00:00' AS SmallDateTime))
GO
INSERT [dbo].[NHANVIEN] ([MANV], [HOTEN], [SODT], [NGVL]) VALUES (N'NV03', N'Nguyen Van B', N'997047382', CAST(N'2006-04-27T00:00:00' AS SmallDateTime))
GO
INSERT [dbo].[NHANVIEN] ([MANV], [HOTEN], [SODT], [NGVL]) VALUES (N'NV04', N'Ngo Thanh Tuan', N'913758498', CAST(N'2006-06-24T00:00:00' AS SmallDateTime))
GO
INSERT [dbo].[NHANVIEN] ([MANV], [HOTEN], [SODT], [NGVL]) VALUES (N'NV05', N'Nguyen Thi Truc Thanh', N'918590387', CAST(N'2006-07-20T00:00:00' AS SmallDateTime))
GO
